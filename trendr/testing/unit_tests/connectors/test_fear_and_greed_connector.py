...
def test_convert_time(unix_time) -> str:
    """
...
def test_get_current_crypto_fear_and_greed():
    """
...
def test_get_current_stock_fear_and_greed():
    """
...
def test_get_crypto_historic_values(days: int = 365):
    """
...
def test_print_historic_values(values: []):
    for value in values:
        print(value)
