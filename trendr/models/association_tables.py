...
search_reddit_submission_association = Table(
    ...
    db.metadata,
    db.Column("search_id", db.Integer(), ForeignKey("search.id"), primary_key=True),
    db.Column("reddit_submission_id", db.Integer(), ForeignKey("reddit_submission.id"), primary_key=True),
)
search_reddit_comment_association = Table(
    "search_reddit_comment",
    db.metadata,
    db.Column("search_id", db.Integer(), ForeignKey("search.id"), primary_key=True),
    db.Column("reddit_comment_id", db.Integer(), ForeignKey("reddit_comment.id"), primary_key=True),
)
